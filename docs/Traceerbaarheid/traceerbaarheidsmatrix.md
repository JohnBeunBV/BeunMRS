...
| **NFR-4** — OpenMRS 2.7.x compatibiliteit                              | ADR-003          | Gebruikt uitsluitend `/ws/rest/v1/` endpoints die stabiel zijn sinds OpenMRS 2.x; geen FHIR2 (zie HAPI-0302 notitie in ADR-003)                               | `postmanrequests.md` — gedocumenteerde endpoints; `docs/Info/OpdrachtOpenMRS.md` versievereiste                                            | ✅                                           |
